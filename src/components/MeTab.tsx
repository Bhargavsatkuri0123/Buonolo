...
export const MeTab = ({
  ...
  const SettingsScreen = () => {
        ...
        <div className="pb-24">
          ...
          <div className={`${T.card} mx-4 rounded-2xl p-4 space-y-4`}>
            <div>
              ...
              <button 
                onClick={() => {
                  ...
                  setTimeout(() => {
                    ...
                    alert("Data archive request received! We'll notify you when it's ready.");
                  }, 1500);
                }}
              ...
              >
                {isArchiving ? "Requesting..." : "Request Data Archive"}
              </button>
            </div>
    ...
    if (settingsSubScreen === "blocked") return (
      <div className="pb-24">
        ...
        <div className={`${T.card} mx-4 rounded-2xl p-6 text-center`}>
          ...
          <p className={`text-xs mt-1 ${T.sub}`}>Accounts you block will appear here.</p>
        </div>
      </div>
    );
      ...
      <div className="pb-24">
        ...
        <div className={`${T.card} mx-4 rounded-2xl divide-y ${T.line} mb-5`}>
          {[["goals", "Goal reminders & deadlines"], ["community", "Community replies & messages"], ["news", "Daily local news brief"]].map(([k, label]) => (
            <button key={k} onClick={() => setNotif((n: any) => ({ ...n, [k]: !n[k as keyof typeof notif] }))} className="flex items-center justify-between w-full p-4">
