...
CREATE TABLE "HostInfo" (
    ...
    "toolSections" JSONB NOT NULL DEFAULT '[]',
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE INDEX "GroupUpdate_groupId_idx" ON "GroupUpdate"("groupId");
...
-- CreateIndex
CREATE UNIQUE INDEX "HostInfo_host_city_key" ON "HostInfo"("host", "city");
...
-- AddForeignKey
ALTER TABLE "GroupUpdate" ADD CONSTRAINT "GroupUpdate_groupId_fkey" FOREIGN KEY ("groupId") REFERENCES "Group"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "GroupUpdate" ADD CONSTRAINT "GroupUpdate_authorId_fkey" FOREIGN KEY ("authorId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
